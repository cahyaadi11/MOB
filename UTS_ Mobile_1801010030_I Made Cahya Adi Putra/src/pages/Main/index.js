    ...
    return (
        <ScrollView showsHorizontalScrollIndicator={false}>
            <View style={styles.content}>
                <Text style={{color: '#fff', textAlign: 'center', fontSize: 18, maxWidth: 250 }}>Segera Pesan Ruangan Anda</Text>
            </View>

            <View style={styles.cardsWrapper}>
              <Text style={{color: '#333'}}>List Room</Text>
  ...
  return (
    <ScrollView>
        <View style={{backgroundColor: colors.default, borderBottomLeftRadius: 28, borderBottomRightRadius: 28, justifyContent: 'center', alignItems: 'center', padding: 40}}>
          ...
          <Text style={{fontSize: 28, fontWeight: 'bold', color: '#fff', marginTop: 18}}>I Made Cahya Adi Putra Putra</Text>
        </View>
        ...
        <View style={styles.cardsWrapper}>
          <View style={styles.card}>
            ...
            <View style={styles.cardInfo}>
                <Text style={styles.cardTitle}>Room C</Text>
                <Text>di pesan pada 25 Januari 2021</Text>
                <Button type="booked" name="booked" onPress={() => alert('Sudah di Booking pada tgl 25 Januari 2021')} />
            </View>
          </View>
        </View>
    </ScrollView>
